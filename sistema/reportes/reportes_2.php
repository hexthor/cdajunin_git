...
<div class="container-fluid">
  ...
  <br>
    ...
    <form id="formulario_reporte" class="form-horizontal" role="form" method="post" data-toggle="validator" target="_blank" action="reporte_pdf.php">
        ...
        <div class="col-xs-12 col-sm-6">
				<div class="checkbox">
                <label>
                  <input type="checkbox" id="check_actividades" name="check_actividades" value="1" checked> <strong>Actividades.</strong>
                </label>
              	</div>
                <br>
                <div class="checkbox">
                <label>
                  <input type="checkbox" id="check_pendientes" name="check_pendientes" value="1" checked> <strong>Pendientes.</strong>
                </label>
              	</div>
                <br>
                <div class="checkbox">
                <label>
                  <input type="checkbox" id="check_asignaciones" name="check_asignaciones" value="1" checked> <strong>Asignaciones.</strong>
                </label>
              	</div>
                <br>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-6">    
            <div class="input-daterange input-group" id="datepicker">
                ...
                <input class="form-control" name="fecha_desde" id="fecha_desde" type="text" placeholder="Desde:" required >
                <span class="input-group-addon"><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span></span>
                <input class="form-control" name="fecha_hasta" id="fecha_hasta" type="text" placeholder="Hasta:" required >
            </div>
        </div>
    </div>
      ...
      <div class="form-group">
            <div class="col-xs-12 text-right">
             <button type="submit" id="generar" name="generar" title="Generar Reporte" class="btn btn-default btn-xs-text"><span class="glyphicon glyphicon-print" aria-hidden="true"></span>&nbsp;Generar PDF</button>
            </div>
        </div> 
